                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700/60">
                            ...
                            <tr class="bg-gray-100 dark:bg-gray-700/30">
                                <td colspan="3" class="px-6 py-3 text-sm font-semibold text-gray-700 dark:text-gray-200">
                                    Etapa: {{ $stage->name }}
                                </td>
                            </tr>
                            ...
                            @php
                            $progreso = $alumno->getProgressInStage($stage->id);
                            @endphp
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <span class=" hidden block text-xs text-gray-400 dark:text-gray-500">ID:
                                                #{{ $alumno->id }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="w-full bg-gray-200 dark:bg-gray-700 h-2 rounded-full overflow-hidden">
                                            <div x-data="{ progreso: {{ $progreso }} }" class="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                                        ...
                                        <span class="text-sm font-semibold text-gray-700 dark:text-gray-300 min-w-[40px] text-right">
                                            {{ $progreso }}%
                                        </span>
                                    </div>
                                </td>
