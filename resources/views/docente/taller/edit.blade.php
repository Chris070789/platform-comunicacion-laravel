                                ...
                                <form method="POST" action="{{ route('docente.taller.update', $workshop) }}">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="title" name="title" type="text"
                                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out"
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <x-text-input id="max_points" name="max_points" type="number" min="1"
                                            class="mt-1 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150 ease-in-out"
