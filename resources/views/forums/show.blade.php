    ...
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div
            ...
            <div md:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow border-gray-200 dark:border-gray-700">
                <h3
                    class="text-xl bg-white dark:bg-gray-800 dark:text-white p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700 transition-colors">
                    Temas en discusión</h3>
            </div>
